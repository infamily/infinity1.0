...
class StepCreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['investables'].label = _('<b>Investables:</b> (e.g., describe the quantities of assets you expect to be needed to complete this milestone, optionally denote their price in <a href="https://research.stlouisfed.org/fred2/series/CES0500000003" target="_blank">h</a>.)')
        ...
        self.fields['deliverables'].label = _('<b>Deliverables:</b> (e.g., describe the quantities assets you expect to have by completion of this milestone, optionally denote their price in <a href="https://research.stlouisfed.org/fred2/series/CES0500000003" target="_blank">h</a>.)')
        self.fields['deliverables'].widget.attrs.update({'placeholder': _('complete solar assembly drawings 0:1, solar cell assembly 1:2@5.5h')})
        self.fields['personal'].label = _('<b>Personal</b> (makes the entry visible only to a chosen set of people)')
        self.fields['language'].label = _('<b>Input Language</b> (the language you used to compose this post) ')
        self.fields['is_link'].label = _('<b>This is a link</b> (check if you are only linking to existing content)')
        self.fields['url'].label = _('<b>Origin:</b> (of the source)')
